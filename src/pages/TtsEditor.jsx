...
function TtsEditor() {
  ...
  const handlePasteSuccess = useCallback((validData) => {
  ...
  }, [setFileName, setMessage, setOpenPasteDialog]);

  const handlePasteError = useCallback((error) => {
  ...
  return (
      <Container maxWidth="xl" sx={{ py: 3 }}>
          ...
          <ExcelPasteDialog
            ...
            onDataImported={handlePasteSuccess}
