 ...
 * @param {Function} setMessage - Callback to set UI messages (e.g. snackbar/alert).
 * @returns {Object} Authentication state and handlers.
 */
export const useBaizeAuth = (setMessage) => {
    // Init user from local storage via lazy initialization to avoid useEffect setState warning
