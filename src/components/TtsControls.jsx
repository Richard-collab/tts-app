...
import { voiceOptions, speedOptions, volumeOptions, pitchOptions } from '../constants/ttsConfig';

/**
 * TtsControls Component
 *
 * Renders the configuration controls for Text-to-Speech synthesis,
 * including Voice, Speed, Volume, Pitch, and Text Split options.
 *
 * @param {Object} props
 ...
 * @param {string} props.splitOption - Selected split option ('yes' or 'no')
